...
<div class="card">
  ...
  <div class="card-body">
    <div class="clearfix mt-2 mb-2">
        <add-component :url="'company-type-new'" :title="'Agregar Nuevo Tipo de Empresa'" ></add-component>
    ...
    <div class="table-responsive">
      <b-table striped hover show-empty stacked="sm"
        ...
        <template slot="actions" slot-scope="row">
          <router-link class="btn btn-sm btn-primary" :to="{ name: 'company-type-detail', params: { id: row.item.id }}" >
            <i class="fa fa-info"></i>
          </router-link>
          <router-link class="btn btn-sm btn-primary" :to="{ name: 'company-type-edit', params: { id: row.item.id }}"  >
...
//const loadItems = (search,page = 1) => axios.get('http://localhost:8000/api/company-type',{ params:{ page: page, search: search }});
...
export default {
  ...
  return {
      items: items,
      fields: [
        { key: 'type', label: 'Tipo de Empresa', sortable: false},
